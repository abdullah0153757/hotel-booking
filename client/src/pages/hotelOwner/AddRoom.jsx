...
const AddRoom = () => {
  ...
  return (
    <form>
      <Title align='left' font='outfit' title='Add Room' subTitle='Provide accurate room details, clear pricing, and appealing amenities. Create a smooth, engaging booking experience.' />
