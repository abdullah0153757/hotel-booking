...
const Dashboard = () => {
    ...
    return (
        <div>
            <Title align='left' font='outfit' title='Dashboard' subTitle='Manage your room listings, monitor bookings, and track revenue—all in one place. Get real-time insights to keep operations smooth and guests satisfied.' />
