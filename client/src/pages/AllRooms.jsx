    ...
    <div   className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        <div>
            <div className='flex flex-col items-start text-left'>
                ...
                <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>Discover BayVoy’s Cox’s Bazar hotel deals and curated packages — crafted for comfort, value, and unforgettable memories.</p>
            </div>
