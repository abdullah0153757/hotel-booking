  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
        <div className='flex flex-col md:flex-row items-center justify-between w-full'>
            <Title align='left' title='Exclusive BayVoy Offers' subTitle='Enjoy limited-time deals and curated packages designed to elevate your Cox’s Bazar stay with comfort, value, and unforgettable moments.'/>
